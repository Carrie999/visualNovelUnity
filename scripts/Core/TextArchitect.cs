...
public class TextArchitect
{
    ...
    public TextArchitect(TextMeshProUGUI tmpro_ui = null, TextMeshPro tmpro_world = null)
    {


        this.tmpro_ui = tmpro_ui;
        this.tmpro_world = tmpro_world;
        this.tmpro = tmpro_ui != null ? tmpro_ui : tmpro_world;
        this.fullTargetText = preText + targetText;
        // Debug.Log(this.fullTargetText);
        this.isBuilding = buildProcess != null;
        if (this.tmpro != null)
        {
            this.currentText = tmpro.text;
        }
    }
    ...
    public Coroutine Build(string text)
    {
        if (tmpro == null)
        {
            Debug.LogError("TMP_Text component is not initialized.");
            return null;
        }
        ...
        tmpro = tmpro_ui != null ? tmpro_ui : tmpro_world;
        fullTargetText = preText + targetText;
        // Debug.Log(fullTargetText);
        isBuilding = buildProcess != null;
        if (tmpro != null)
        {
            currentText = tmpro.text;
        }
    ...
    private void Prepare_Typewriter()
    {
        ...
        // Implementation for typewriter preparation
    }
    ...
    private void Prepare_Fade()
    {
        ...
        tmpro.ForceMeshUpdate();
        // Implementation for fade preparation
